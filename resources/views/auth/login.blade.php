        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-5">
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="row g-0">
                        <div class="col-md-12 d-none d-md-flex align-items-center justify-content-center p-3 bg-light">
                            <img src="{{ asset('images/logo_dark.webp') }}" class="img-fluid w-50" alt="Logo">
                        </div>
